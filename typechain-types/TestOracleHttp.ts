...
export interface TestOracleHttpInterface extends utils.Interface {
  contractName: "TestOracleHttp";
  functions: {
    "fulfill(bytes32,uint256)": FunctionFragment;
    "requestHelloOracle()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "requestHelloOracle",
    values?: undefined
  ): string;
...
export interface TestOracleHttp extends BaseContract {
  contractName: "TestOracleHttp";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestOracleHttpInterface;
  ...
  callStatic: {
    ...
    requestHelloOracle(overrides?: CallOverrides): Promise<string>;
